# nano-l1: the matching engine

the low-latency trading system this repository started as, and which the
explainability research in [the README](../README.md) was built alongside. the
engine is unchanged by that work; both are documented here so neither crowds
the other out.
