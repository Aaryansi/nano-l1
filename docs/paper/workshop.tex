...
\twocolumn[
  ...
  distribution is $42\times$ wider on CartPole, and across sixteen checkpoints
  on four control tasks it never exceeds $z=2.45$, including on a converged
  policy. Its width is exactly the spread of random-initialisation return.
