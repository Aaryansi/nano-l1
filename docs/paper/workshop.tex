...
return difference is detected. A non-significant paired comparison is not
evidence of equivalence, so the claim is the weaker one: the attribution moved
almost entirely without a detected cost. Explanations are steerable without a
