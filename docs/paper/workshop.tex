...
contribution: the construction already in use has almost no power, and each of
the three natural replacements fails in its own way.

\paragraph{Contributions.}
\begin{enumerate}[leftmargin=1.2em,itemsep=1pt,topsep=2pt]
\item The incumbent null has near-zero power in RL, and its width is an identity:
it equals the standard deviation of random-initialisation return.
...
\item Attribution is not identified by behaviour: it can be forged at a price
